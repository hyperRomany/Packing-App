...
public class RecievedPackages_ShowAdapter extends RecyclerView.Adapter<RecievedPackages_ShowAdapter.MyViewHolder> {
    ...
    public RecievedPackages_ShowAdapter(List<RecievedPackageModule> moviesList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.recycle_item_for_packed_packages_recieve, parent, false);
